...
{  
     ...
     * 通过GET方式发送请求 
     * 请求后将会返回串oauth_token=字符串&oauth_token_secret=字符串&oauth_callback_confirmed=trued 
     * @param url URL地址 
     * @param params 参数 
     * @return  
     * @throws Exception 
...
//              获取输入流  
     ...
     * @throws Exception 
     */  
    public String postWithFile(String httpUrl, String queryString, List<Parameter> files) throws Exception  
    {  
        //数据分隔线  
                ...
                {  
                    ...
                    {  
                        ...
                        {  
                            ...
                            //获取参数值  
                            String value = (param.length == 2 ? TextUtil.decode(param[1]) : "");  
                            //添加数据分隔线  
